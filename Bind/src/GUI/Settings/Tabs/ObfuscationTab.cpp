...
void ObfuscationTab::initUI()
{
    ...
    encryptionMethod->addItem("Basic XOR (Simple)", static_cast<int>(DirectObfuscation::EncryptionMethod::BasicXOR));
    encryptionMethod->addItem("Multi key XOR (Medium)", static_cast<int>(DirectObfuscation::EncryptionMethod::MultiKeyXOR));
    encryptionMethod->addItem("Add + XOR (Medium)", static_cast<int>(DirectObfuscation::EncryptionMethod::AddXORCombo));
    encryptionMethod->addItem("Enhanced XOR (Medium)", static_cast<int>(DirectObfuscation::EncryptionMethod::EnhancedXOR));
    encryptionMethod->addItem("Offset Shifting (Medium)", static_cast<int>(DirectObfuscation::EncryptionMethod::OffsetShifting));

    int currentMethod = settings->value("obfuscation/encryption_method", static_cast<int>(DirectObfuscation::EncryptionMethod::BasicXOR)).toInt();

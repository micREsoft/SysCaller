...
var (
	...
	procAllocate         = modSysCaller.NewProc("SysAllocateVirtualMemoryEx")
	procWrite            = modSysCaller.NewProc("SysWriteVirtualMemory")
	procThread           = modSysCaller.NewProc("SysCreateThreadEx")
	procClose            = modSysCaller.NewProc("SysClose")
